...
export const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col px-4 pt-20 pb-16"
    >
      {/* Main content - using flex to push content up and leave space for the scroll indicator */}
      <div className="flex-grow flex flex-col items-center justify-center mb-16">
      ...
      {/* Scroll indicator - positioned at the bottom with margin rather than absolute positioning */}
      <div className="flex justify-center w-full">
        <a 
          href="#about" 
          className="flex flex-col items-center animate-bounce cursor-pointer group hover:text-primary transition-colors duration-300 mt-4"
